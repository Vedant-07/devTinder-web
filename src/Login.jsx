...
const Login = () => {
    ...
    const [email,setEmail]=useState("Clark@email.com")
    const [password,setPassword]=useState("Clark@123")
    ...
    <div className="card bg-base-100 w-96 shadow-xl">
      <div className="card-body ">
        ...
        <div className="card-actions flex flex-col grow  ">
          ...
          <button className="btn btn-primary mt-4 ml-auto" onClick={handleLogin}> Login</button>
        </div>
      </div>
    </div>
  );
